...
describe('about main handler geolocation integration', () => {
  ...
  describe('when CF-IPCountry header is present', () => {
  ...
  describe('when CF-IPCountry header is not present', () => {
    it('should handle request without CF-IPCountry header', async () => {
      const catalysts = {
        getHealhtyCatalysts: jest.fn().mockResolvedValue([
          {
            healthy: true,
  ...
  describe('when preferred catalyst is provided', () => {
    ...
    it('should handle catalysts with unknown URLs gracefully', async () => {
      const catalysts = {
        getHealhtyCatalysts: jest.fn().mockResolvedValue([
          {
            healthy: true,
